...
// DatabaseInsertionError constant
const DatabaseInsertionError string = "Document could not be inserted."

// DatabaseInsertionSuccess constant
const DatabaseInsertionSuccess string = "Document succesfully inserted."
